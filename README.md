# html-resume
A single-page résumé done purely with HTML and CSS, which can be rendered into PDF through web browsers' print-to-PDF functionality, making a nice, sleek, professsional and ready-to-print résumé. See my living example at [Chris Trees html-resume](http://christrees.com/docs/resume_christrees.pdf)

<!-- 
Many thanks to [mnjul html-resume](https://github.com/mnjul/html-resume) github project and his project blog [mnjul blog](https://blogs.purincess.tw/matrixblog/2016/04/typesetting-resume-with-html-and-css/).
